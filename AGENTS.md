...
- Read the package's existing fragments first so you don't duplicate an existing bullet
...
- Do not create changelog fragments when working on a branch other than `main` or a pull request
