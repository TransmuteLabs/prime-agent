...
Content`,
	...
	describe("auto-discovered skill metadata", () => {
		it(`should use the agent dir as baseDir for user ${CONFIG_DIR_NAME} skills`, async () => {
	...
	describe(".agents/skills auto-discovery", () => {
		...
		it(`should dedupe user skill entries when ~/${CONFIG_DIR_NAME}/skills is a symlink to ~/.agents/skills`, async () => {
			const previousHome = process.env.HOME;
			process.env.HOME = tempDir;
	...
	describe("settings source normalization", () => {
		...
		it(`should store project local packages relative to the ${CONFIG_DIR_NAME} settings base`, () => {
