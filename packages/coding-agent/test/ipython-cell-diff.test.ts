...
import { renderRichDiff } from "../src/modes/interactive/components/diff.ts";
...
describe("renderRichDiff syntax highlighting", () => {
	...
	// Color mode comes from the cached terminal capabilities, so the override has
	// to replace that cache; changing the environment alone re-reads nothing.
