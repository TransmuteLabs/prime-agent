...
import { type SideQuestionEvent, startSideQuestion } from "../../../src/core/side-question.ts";
import { AgentDaemon } from "../../../src/modes/daemon/daemon-mode.ts";
import { BashExecutionComponent } from "../../../src/modes/interactive/components/bash-execution.ts";
import { SideQuestionComponent } from "../../../src/modes/interactive/components/side-question.ts";
...
describe("ENG-4509 side questions", () => {
	...
	it("aligns the thinking placeholder with the streamed response", () => {
		...
		expect(rawThinkingLine).toContain(theme.fg("userMessageText", "Thinking…"));
	});
	...
	it("uses the user-message foreground for pane content", () => {
		...
		expect(rendered).toContain(theme.fg("userMessageText", "Readable question"));
		expect(rendered).toContain(theme.fg("userMessageText", "Readable response"));
	});
