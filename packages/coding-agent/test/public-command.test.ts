...
import { SELF_UPDATE_INTERACTIVE_CHILD_ENV } from "../src/config.ts";
...
import { INTERNAL_RUNTIME_COMMAND_MARKER } from "../src/cli/args.ts";
import { formatTopLevelHelp } from "../src/cli/command-registry.ts";
import { DAEMON_UPDATE_RESTART_COORDINATOR_FLAG } from "../src/cli/daemon-update-restart.ts";
import { handlePublicCommand } from "../src/cli/public-command.ts";
