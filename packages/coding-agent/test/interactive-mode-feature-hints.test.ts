...
import { FEATURE_HINT_ANIMATION_INTERVAL_MS } from "../src/modes/interactive/components/feature-hint.ts";
import { FEATURE_HINTS, FeatureHintDeck } from "../src/modes/interactive/feature-hints.ts";
