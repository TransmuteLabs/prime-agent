...
import { selectHeadlessTerminalResult } from "../src/modes/headless-completion.ts";
...
function createRuntimeHost(
	...
	const session: FakeSession = {
		...
		// json print mode subscribes to the agent to pace emission against stdout backpressure.
		agent: { waitForIdle: vi.fn(async () => {}), subscribe: vi.fn(() => () => {}) },
		waitForIdle,
