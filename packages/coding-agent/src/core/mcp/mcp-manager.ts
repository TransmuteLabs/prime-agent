...
import type { AcpMcpServerConfig } from "./acp-mcp-types.ts";
...
export class McpManager {
	 ...
	 * can re-run after any reset of the MCP OAuth registry — otherwise custom
	 * `mcp:<server>` providers vanish and their integrations silently deauthorize.
	 */
