...
import { defaultDaemonSocketDir, normalizeSocketPath } from "./daemon-socket.ts";
...
class RenewableRegistryRecord {
	...
	constructor(registryDir: string, refreshMs: number, renewUnderGuard: () => void, createLostError: () => Error) {
		this.registryDir = registryDir;
		this.renewUnderGuard = renewUnderGuard;
