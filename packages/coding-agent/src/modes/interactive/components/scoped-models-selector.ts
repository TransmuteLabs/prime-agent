...
export class ScopedModelsSelectorComponent extends Container implements Focusable {
	...
	private refresh(): void {
		...
		// A new query re-ranks the list under a stationary cursor: keeping the old index would
		// leave the highlight on whatever row happens to land there and toggle that model on
		// Enter. Every query change puts the cursor back on the top match.
