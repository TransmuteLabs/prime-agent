...
import { resolveAcpMcpServers } from "./acp-mcp.ts";
import { PRIME_AGENT_META_NAMESPACE, type PrimeAgentAutonomousMeta, primeAgentMeta } from "./acp-meta.ts";
...
class AcpUpdateProducer {
	...
	constructor(sessionId: string, client: { notify(method: unknown, params: unknown): Promise<unknown> }) {
