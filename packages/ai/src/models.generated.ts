...
import { PRIME_INFERENCE_MODELS } from "./providers/prime-inference.models.ts";
...
export const MODELS: {
	...
	readonly "prime-inference": typeof PRIME_INFERENCE_MODELS;
	...
	"prime-inference": PRIME_INFERENCE_MODELS,
